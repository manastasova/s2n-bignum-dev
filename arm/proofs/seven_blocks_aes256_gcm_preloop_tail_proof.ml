(* ========================================================================= *)
(* seven_blocks_aes256_gcm_preloop_tail_proof.ml                             *)
(* Companion: bridge to standard ghash_polyval_acc (init word 0).            *)
(* ========================================================================= *)

needs "arm/proofs/seven_blocks_aes256_gcm_preloop_tail_nblock.ml";;

let GHASH_7BLOCK_KARATSUBA_EQ_GHASH_POLYVAL_ACC_INIT = prove
 (`!(b1:int128) (b2:int128) (b3:int128) (b4:int128) (b5:int128) (b6:int128) (b7:int128) (h:int128)
    ...
    ==> ghash_7block_karatsuba b1 b2 b3 b4 b5 b6 b7
        ...
        word_reversefields 8
          (ghash_polyval_acc h (word 0) [b1; b2; b3; b4; b5; b6; b7])`,
  REPEAT GEN_TAC THEN STRIP_TAC THEN
  MP_TAC(SPECL [`b1:int128`; `b2:int128`; `b3:int128`; `b4:int128`; `b5:int128`; `b6:int128`; `b7:int128`;
                `h:int128`; `hk:int128`; `h2k:int128`; `h3k:int128`;
                `h4k:int128`; `h5k:int128`; `h6k:int128`; `h7k:int128`]
...
let GHASH_POLYVAL_ACC_7_INIT = prove
 (`!(b1:int128) (b2:int128) (b3:int128) (b4:int128) (b5:int128) (b6:int128) (b7:int128) (h:int128).
   ghash_polyval_acc h (word 0) [b1; b2; b3; b4; b5; b6; b7] =
   polyval_reduce_prop3
     (word_xor (word_pmul b1 (polyval_dot (polyval_dot (polyval_dot (polyval_dot (polyval_dot (polyval_dot h h) h) h) h) h) h) : 256 word)
     (word_xor (word_pmul b2 (polyval_dot (polyval_dot (polyval_dot (polyval_dot (polyval_dot h h) h) h) h) h) : 256 word)
     (word_xor (word_pmul b3 (polyval_dot (polyval_dot (polyval_dot (polyval_dot h h) h) h) h) : 256 word)
     (word_xor (word_pmul b4 (polyval_dot (polyval_dot (polyval_dot h h) h) h) : 256 word)
     (word_xor (word_pmul b5 (polyval_dot (polyval_dot h h) h) : 256 word)
     (word_xor (word_pmul b6 (polyval_dot h h) : 256 word)
               (word_pmul b7 h : 256 word)))))))`,
  REPEAT GEN_TAC THEN
  MP_TAC(SPECL [`h:int128`; `word 0:int128`;
                `b1:int128`; `b2:int128`; `b3:int128`; `b4:int128`; `b5:int128`; `b6:int128`; `b7:int128`]
               GHASH_POLYVAL_ACC_7) THEN
