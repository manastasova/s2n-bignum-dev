...
let SUBWORD_JOIN_64_128 = prove(
  `!(a:(128)word) (b:(128)word).
    word_subword (word_join a b:(256)word) (64,128):(128)word =
    word_join (word_subword a (0,64):(64)word) (word_subword b (64,64):(64)word)`,
  CONV_TAC WORD_BLAST);;
let SUBWORD_XOR_JOIN_LO = prove(
  `!(a:(128)word) (b:(64)word) (c:(64)word).
    word_subword (word_xor a (word_join b c:(128)word)) (0,64):(64)word =
    word_xor (word_subword a (0,64):(64)word) c`, CONV_TAC WORD_BLAST);;
let SUBWORD_XOR_JOIN_HI = prove(
  `!(a:(128)word) (b:(64)word) (c:(64)word).
    word_subword (word_xor a (word_join b c:(128)word)) (64,64):(64)word =
    word_xor (word_subword a (64,64):(64)word) b`, CONV_TAC WORD_BLAST);;
let JOIN_SUBWORD_LO = prove(
  `!(a:(128)word).
    word_subword (word_join a a:(256)word) (64,128):(128)word =
    word_join (word_subword a (0,64):(64)word) (word_subword a (64,64):(64)word)`,
  CONV_TAC WORD_BLAST);;
let WORD_JOIN_XOR = prove(
  `!(a:(64)word) (b:(64)word) (c:(64)word) (d:(64)word).
    word_join (word_xor a b) (word_xor c d):(128)word =
    word_xor (word_join a c) (word_join b d)`,
  CONV_TAC WORD_BLAST);;
let WORD128_EQ_SPLIT = prove(
  `!(a:(128)word) (b:(128)word).
    word_subword a (0,64):(64)word = word_subword b (0,64) /\
    word_subword a (64,64):(64)word = word_subword b (64,64) ==> a = b`,
  CONV_TAC WORD_BLAST);;
