...
(*   - GCM_7BLOCK_GHASH_STEP_TAC + main theorem AES256_GCM_SEVEN_BLOCK_CORRECT *)
(* ========================================================================= *)
...
let AES256_GCM_SEVEN_BLOCK_EXEC =
...
let AES256_GCM_SEVEN_BLOCK_CORRECT = prove
 (`!in_ptr out_ptr xi_ptr ivec_ptr key_ptr htable_ptr
  ...
  REWRITE_TAC[C_ARGUMENTS; MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI;
              ...
              fst AES256_GCM_SEVEN_BLOCK_EXEC] THEN
  REPEAT STRIP_TAC THEN ENSURES_INIT_TAC "s0" THEN
  ARM_STEPS_TAC AES256_GCM_SEVEN_BLOCK_EXEC (1--19) THEN
  ...
  MAP_EVERY (fun n ->
    ARM_STEPS_TAC AES256_GCM_SEVEN_BLOCK_EXEC [n] THEN
  ...
  MAP_EVERY (fun n ->
    ARM_STEPS_TAC AES256_GCM_SEVEN_BLOCK_EXEC [n] THEN GCM_ENC_SIMPLIFY_TAC THEN
    RULE_ASSUM_TAC(REWRITE_RULE[ARITH_RULE `18446744073709551616 = 2 EXP 64`]) THEN
  ...
  ARM_STEPS_TAC AES256_GCM_SEVEN_BLOCK_EXEC (391--398) THEN
