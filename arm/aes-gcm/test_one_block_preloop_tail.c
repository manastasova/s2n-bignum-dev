// Test: compare one_block_aes256_gcm_preloop_tail against aws-lc EVP AES-256-GCM
//
// Build:
//   gcc -O2 -o test_one_block_preloop_tail \
//     test_one_block_preloop_tail.c \
//     one_block_aes256_gcm_preloop_tail.S \
...
extern size_t one_block_aes256_gcm_preloop_tail(
...
static int run_test(const char *name,
    ...
    // -----------------------------------------------------------------
    // 2) Our assembly: one_block_aes256_gcm_preloop_tail
    ...
    size_t ret = one_block_aes256_gcm_preloop_tail(
