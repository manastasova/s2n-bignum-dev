// Test: compare seven_blocks_aes256_gcm_preloop_tail against aws-lc EVP AES-256-GCM
//
// Build:
//   gcc -O2 -o test_seven_blocks_preloop_tail \
//     test_seven_blocks_preloop_tail.c \
//     seven_blocks_aes256_gcm_preloop_tail.S \
...
extern size_t seven_blocks_aes256_gcm_preloop_tail(
...
static int run_test(const char *name,
    ...
    // ----------------------------------------------------------------
    // 2) Our assembly: seven_blocks_aes256_gcm_preloop_tail
    // ----------------------------------------------------------------
    ...
    size_t ret = seven_blocks_aes256_gcm_preloop_tail(
