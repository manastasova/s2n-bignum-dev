...
(**** print_literal_from_elf "x86/sha3/sha3_keccak4_f1600_alt_2.o";;
****)

let sha3_keccak4_f1600_alt_2_7_mc = define_assert_from_elf
  "sha3_keccak4_f1600_alt_2_7_mc" "x86/sha3/sha3_keccak4_f1600_alt_2.o"
[
  ...
  0xc5; 0xfe; 0x7f; 0x9c; 0x24; 0x20; 0x01; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,288))) (%_% ymm3) *)
  0xc4; 0xe3; 0x7d; 0x46; 0xd9; 0x31;
                           (* VPERM2I128 (%_% ymm3) (%_% ymm0) (%_% ymm1) (Imm8 (word 49)) *)
  0xc5; 0xfe; 0x7f; 0xbc; 0x24; 0xe0; 0x01; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,480))) (%_% ymm7) *)
  ...
  0xc5; 0xfe; 0x7f; 0xbc; 0x24; 0x00; 0x01; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,256))) (%_% ymm7) *)
  0xc5; 0xfd; 0x6c; 0xd3;  (* VPUNPCKLQDQ (%_% ymm2) (%_% ymm0) (%_% ymm3) *)
  0xc5; 0xfd; 0x6d; 0xc3;  (* VPUNPCKHQDQ (%_% ymm0) (%_% ymm0) (%_% ymm3) *)
  0xc5; 0xf5; 0x6c; 0xdc;  (* VPUNPCKLQDQ (%_% ymm3) (%_% ymm1) (%_% ymm4) *)
  0xc4; 0xe3; 0x6d; 0x46; 0xfb; 0x20;
  ...
  0xc5; 0xfe; 0x7f; 0xbc; 0x24; 0x20; 0x02; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,544))) (%_% ymm7) *)
  ...
  0xc4; 0xe3; 0x7d; 0x46; 0xd9; 0x31;
                           (* VPERM2I128 (%_% ymm3) (%_% ymm0) (%_% ymm1) (Imm8 (word 49)) *)
  0xc5; 0xfe; 0x7f; 0xbc; 0x24; 0xa0; 0x02; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,672))) (%_% ymm7) *)
  0xc4; 0xe3; 0x7d; 0x46; 0xf9; 0x20;
                           (* VPERM2I128 (%_% ymm7) (%_% ymm0) (%_% ymm1) (Imm8 (word 32)) *)
  ...
  0xc5; 0xfe; 0x7f; 0x9c; 0x24; 0x60; 0x02; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,608))) (%_% ymm3) *)
  ...
  0xc5; 0xfe; 0x7f; 0xbc; 0x24; 0x80; 0x02; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,640))) (%_% ymm7) *)
  0xc5; 0xfd; 0x6c; 0xd3;  (* VPUNPCKLQDQ (%_% ymm2) (%_% ymm0) (%_% ymm3) *)
  0xc5; 0xfd; 0x6d; 0xc3;  (* VPUNPCKHQDQ (%_% ymm0) (%_% ymm0) (%_% ymm3) *)
  ...
  0xc5; 0xfe; 0x7f; 0xa4; 0x24; 0x40; 0x02; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,576))) (%_% ymm4) *)
  ...
  0xc5; 0xfe; 0x6f; 0xa4; 0x24; 0x80; 0x01; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm4) (Memop Word256 (%% (rsp,384))) *)
  ...
  0xc5; 0x7e; 0x6f; 0x9c; 0x24; 0x00; 0x02; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm11) (Memop Word256 (%% (rsp,512))) *)
  0xc5; 0x7e; 0x6f; 0xa4; 0x24; 0xa0; 0x02; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm12) (Memop Word256 (%% (rsp,672))) *)
  0xc5; 0xfe; 0x7f; 0x5c; 0x24; 0x40;
                           (* VMOVDQU (Memop Word256 (%% (rsp,64))) (%_% ymm3) *)
  0xc5; 0xdd; 0xef; 0x8c; 0x24; 0xe0; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm1) (%_% ymm4) (Memop Word256 (%% (rsp,736))) *)
  0xc5; 0x7e; 0x6f; 0x94; 0x24; 0x20; 0x01; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm10) (Memop Word256 (%% (rsp,288))) *)
  0xc5; 0xfe; 0x7f; 0x64; 0x24; 0x20;
                           (* VMOVDQU (Memop Word256 (%% (rsp,32))) (%_% ymm4) *)
  0xc5; 0x1d; 0xef; 0xe3;  (* VPXOR (%_% ymm12) (%_% ymm12) (%_% ymm3) *)
  0xc5; 0xfe; 0x6f; 0xb4; 0x24; 0x00; 0x01; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm6) (Memop Word256 (%% (rsp,256))) *)
  0xc5; 0xfe; 0x6f; 0xa4; 0x24; 0xa0; 0x01; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm4) (Memop Word256 (%% (rsp,416))) *)
  0xc5; 0x7e; 0x7f; 0xb4; 0x24; 0xa0; 0x00; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,160))) (%_% ymm14) *)
  0xc5; 0xfd; 0xef; 0xc1;  (* VPXOR (%_% ymm0) (%_% ymm0) (%_% ymm1) *)
  0xc4; 0xc1; 0x25; 0xef; 0xc8;
                           (* VPXOR (%_% ymm1) (%_% ymm11) (%_% ymm8) *)
  0xc5; 0x45; 0xef; 0x9c; 0x24; 0x80; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm11) (%_% ymm7) (Memop Word256 (%% (rsp,640))) *)
  0xc5; 0x7e; 0x7f; 0x94; 0x24; 0x80; 0x00; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,128))) (%_% ymm10) *)
  0xc5; 0x1d; 0xef; 0xe1;  (* VPXOR (%_% ymm12) (%_% ymm12) (%_% ymm1) *)
  0xc4; 0xc1; 0x35; 0xef; 0xcf;
                           (* VPXOR (%_% ymm1) (%_% ymm9) (%_% ymm15) *)
  0xc5; 0xfe; 0x6f; 0x9c; 0x24; 0x20; 0x02; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm3) (Memop Word256 (%% (rsp,544))) *)
  0xc5; 0x7e; 0x7f; 0x44; 0x24; 0x60;
                           (* VMOVDQU (Memop Word256 (%% (rsp,96))) (%_% ymm8) *)
  0xc5; 0x25; 0xef; 0xd9;  (* VPXOR (%_% ymm11) (%_% ymm11) (%_% ymm1) *)
  0xc5; 0x8d; 0xef; 0x8c; 0x24; 0xc0; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm1) (%_% ymm14) (Memop Word256 (%% (rsp,704))) *)
  0xc5; 0x1d; 0xef; 0xe6;  (* VPXOR (%_% ymm12) (%_% ymm12) (%_% ymm6) *)
  0xc5; 0x7e; 0x6f; 0x84; 0x24; 0x40; 0x01; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm8) (Memop Word256 (%% (rsp,320))) *)
  0xc4; 0x41; 0x25; 0xef; 0xda;
                           (* VPXOR (%_% ymm11) (%_% ymm11) (%_% ymm10) *)
  0xc5; 0x15; 0xef; 0x94; 0x24; 0x40; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm10) (%_% ymm13) (Memop Word256 (%% (rsp,576))) *)
  ...
  0xc5; 0xfd; 0xef; 0x84; 0x24; 0xe0; 0x01; 0x00; 0x00;
                           (* VPXOR (%_% ymm0) (%_% ymm0) (Memop Word256 (%% (rsp,480))) *)
  0xc5; 0x2d; 0xef; 0xd1;  (* VPXOR (%_% ymm10) (%_% ymm10) (%_% ymm1) *)
  0xc5; 0xfe; 0x6f; 0x8c; 0x24; 0x60; 0x01; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm1) (Memop Word256 (%% (rsp,352))) *)
  0xc4; 0x41; 0x2d; 0xef; 0xd0;
                           (* VPXOR (%_% ymm10) (%_% ymm10) (%_% ymm8) *)
  0xc5; 0x7e; 0x6f; 0xf1;  (* VMOVDQU (%_% ymm14) (%_% ymm1) *)
  0xc5; 0xed; 0xef; 0x8c; 0x24; 0x60; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm1) (%_% ymm2) (Memop Word256 (%% (rsp,608))) *)
  0xc5; 0x7e; 0x7f; 0xb4; 0x24; 0xe0; 0x00; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,224))) (%_% ymm14) *)
  ...
  0xc5; 0x65; 0xef; 0xa4; 0x24; 0xe0; 0x01; 0x00; 0x00;
                           (* VPXOR (%_% ymm12) (%_% ymm3) (Memop Word256 (%% (rsp,480))) *)
  ...
  0xc5; 0x5d; 0xef; 0x94; 0x24; 0x00; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm10) (%_% ymm4) (Memop Word256 (%% (rsp,512))) *)
  ...
  0xc5; 0x7e; 0x7f; 0xbc; 0x24; 0x00; 0x01; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,256))) (%_% ymm15) *)
  ...
  0xc5; 0x7e; 0x7f; 0x9c; 0x24; 0x20; 0x01; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,288))) (%_% ymm11) *)
  ...
  0xc5; 0x7e; 0x7f; 0x9c; 0x24; 0x40; 0x01; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,320))) (%_% ymm11) *)
  ...
  0xc5; 0x7e; 0x7f; 0x9c; 0x24; 0x60; 0x01; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,352))) (%_% ymm11) *)
  0xc5; 0x3d; 0xeb; 0xc2;  (* VPOR (%_% ymm8) (%_% ymm8) (%_% ymm2) *)
  0xc5; 0xfd; 0xef; 0x94; 0x24; 0x20; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm2) (%_% ymm0) (Memop Word256 (%% (rsp,544))) *)
  ...
  0xc5; 0x65; 0xef; 0x94; 0x24; 0xe0; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm10) (%_% ymm3) (Memop Word256 (%% (rsp,736))) *)
  ...
  0xc5; 0x7e; 0x7f; 0x9c; 0x24; 0x80; 0x01; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,384))) (%_% ymm11) *)
  0xc5; 0x5d; 0xef; 0x9c; 0x24; 0xa0; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm11) (%_% ymm4) (Memop Word256 (%% (rsp,672))) *)
  ...
  0xc5; 0x7e; 0x7f; 0xa4; 0x24; 0x00; 0x02; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,512))) (%_% ymm12) *)
  ...
  0xc5; 0xfd; 0xef; 0xbc; 0x24; 0x60; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm7) (%_% ymm0) (Memop Word256 (%% (rsp,608))) *)
  0xc5; 0x35; 0xeb; 0xca;  (* VPOR (%_% ymm9) (%_% ymm9) (%_% ymm2) *)
  0xc5; 0xf5; 0xef; 0x94; 0x24; 0xc0; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm2) (%_% ymm1) (Memop Word256 (%% (rsp,704))) *)
  ...
  0xc5; 0x7e; 0x7f; 0xa4; 0x24; 0xe0; 0x02; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,736))) (%_% ymm12) *)
  ...
  0xc5; 0x7e; 0x7f; 0xa4; 0x24; 0xc0; 0x02; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,704))) (%_% ymm12) *)
  0xc5; 0x4d; 0xef; 0xe2;  (* VPXOR (%_% ymm12) (%_% ymm6) (%_% ymm2) *)
  0xc5; 0xfd; 0xef; 0xb4; 0x24; 0xe0; 0x00; 0x00; 0x00;
                           (* VPXOR (%_% ymm6) (%_% ymm0) (Memop Word256 (%% (rsp,224))) *)
  0xc5; 0xfd; 0xef; 0x84; 0x24; 0xc0; 0x00; 0x00; 0x00;
                           (* VPXOR (%_% ymm0) (%_% ymm0) (Memop Word256 (%% (rsp,192))) *)
  ...
  0xc5; 0xe5; 0xef; 0x74; 0x24; 0x20;
                           (* VPXOR (%_% ymm6) (%_% ymm3) (Memop Word256 (%% (rsp,32))) *)
  0xc5; 0xe5; 0xef; 0x1c; 0x24;
                           (* VPXOR (%_% ymm3) (%_% ymm3) (Memop Word256 (%% (rsp,0))) *)
  ...
  0xc5; 0xdd; 0xef; 0x74; 0x24; 0x60;
                           (* VPXOR (%_% ymm6) (%_% ymm4) (Memop Word256 (%% (rsp,96))) *)
  0xc5; 0xdd; 0xef; 0x64; 0x24; 0x40;
                           (* VPXOR (%_% ymm4) (%_% ymm4) (Memop Word256 (%% (rsp,64))) *)
  ...
  0xc5; 0xd5; 0xef; 0xb4; 0x24; 0x80; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm6) (%_% ymm5) (Memop Word256 (%% (rsp,640))) *)
  0xc5; 0xd5; 0xef; 0xac; 0x24; 0x80; 0x00; 0x00; 0x00;
                           (* VPXOR (%_% ymm5) (%_% ymm5) (Memop Word256 (%% (rsp,128))) *)
  ...
  0xc5; 0xfe; 0x7f; 0xb4; 0x24; 0xa0; 0x02; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,672))) (%_% ymm6) *)
  0xc5; 0xf5; 0xef; 0xb4; 0x24; 0x40; 0x02; 0x00; 0x00;
                           (* VPXOR (%_% ymm6) (%_% ymm1) (Memop Word256 (%% (rsp,576))) *)
  0xc5; 0xf5; 0xef; 0x8c; 0x24; 0xa0; 0x00; 0x00; 0x00;
                           (* VPXOR (%_% ymm1) (%_% ymm1) (Memop Word256 (%% (rsp,160))) *)
  ...
  0xc5; 0x7e; 0x7f; 0xac; 0x24; 0x80; 0x02; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,640))) (%_% ymm13) *)
  ...
  0xc5; 0xfe; 0x7f; 0x94; 0x24; 0x60; 0x02; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,608))) (%_% ymm2) *)
  ...
  0xc5; 0xfe; 0x7f; 0xac; 0x24; 0x40; 0x02; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rsp,576))) (%_% ymm5) *)
  0x48; 0x83; 0xc6; 0x08;  (* ADD (% rsi) (Imm8 (word 8)) *)
  0x49; 0x83; 0xc2; 0x01;  (* ADD (% r10) (Imm8 (word 1)) *)
  0x49; 0x83; 0xfa; 0x18;  (* CMP (% r10) (Imm8 (word 24)) *)
  0x0f; 0x85; 0xfa; 0xfa; 0xff; 0xff;
                           (* JNE (Imm32 (word 4294966010)) *)
  ...
  0xc5; 0xfe; 0x6f; 0x8c; 0x24; 0x40; 0x01; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm1) (Memop Word256 (%% (rsp,320))) *)
  ...
  0xc5; 0xfe; 0x6f; 0x84; 0x24; 0x00; 0x02; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm0) (Memop Word256 (%% (rsp,512))) *)
  ...
  0xc4; 0xe3; 0x6d; 0x46; 0xd4; 0x31;
                           (* VPERM2I128 (%_% ymm2) (%_% ymm2) (%_% ymm4) (Imm8 (word 49)) *)
  0xc5; 0xfe; 0x6f; 0xa4; 0x24; 0x20; 0x02; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm4) (Memop Word256 (%% (rsp,544))) *)
  0xc4; 0xe3; 0x75; 0x46; 0xc8; 0x31;
                           (* VPERM2I128 (%_% ymm1) (%_% ymm1) (%_% ymm0) (Imm8 (word 49)) *)
  0xc5; 0xfe; 0x6f; 0x84; 0x24; 0xe0; 0x02; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm0) (Memop Word256 (%% (rsp,736))) *)
  ...
  0xc4; 0xe3; 0x75; 0x46; 0xc8; 0x31;
                           (* VPERM2I128 (%_% ymm1) (%_% ymm1) (%_% ymm0) (Imm8 (word 49)) *)
  0xc5; 0xfe; 0x6f; 0xa4; 0x24; 0xc0; 0x02; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm4) (Memop Word256 (%% (rsp,704))) *)
  0xc5; 0xfe; 0x6f; 0x84; 0x24; 0xa0; 0x01; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm0) (Memop Word256 (%% (rsp,416))) *)
  ...
  0xc4; 0xe3; 0x75; 0x46; 0xe8; 0x20;
                           (* VPERM2I128 (%_% ymm5) (%_% ymm1) (%_% ymm0) (Imm8 (word 32)) *)
  0xc5; 0xfe; 0x6f; 0xa4; 0x24; 0xa0; 0x02; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm4) (Memop Word256 (%% (rsp,672))) *)
  0xc4; 0xe3; 0x75; 0x46; 0xc8; 0x31;
                           (* VPERM2I128 (%_% ymm1) (%_% ymm1) (%_% ymm0) (Imm8 (word 49)) *)
  0xc5; 0xfe; 0x6f; 0x84; 0x24; 0x80; 0x02; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm0) (Memop Word256 (%% (rsp,640))) *)
  0xc5; 0xfe; 0x7f; 0xaf; 0x28; 0x01; 0x00; 0x00;
                           (* VMOVDQU (Memop Word256 (%% (rdi,296))) (%_% ymm5) *)
  0xc5; 0xfe; 0x6f; 0xac; 0x24; 0x60; 0x02; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm5) (Memop Word256 (%% (rsp,608))) *)
  ...
  0xc5; 0xfe; 0x6f; 0xa4; 0x24; 0x40; 0x02; 0x00; 0x00;
                           (* VMOVDQU (%_% ymm4) (Memop Word256 (%% (rsp,576))) *)
  0xc4; 0xe3; 0x7d; 0x46; 0xe9; 0x20;
                           (* VPERM2I128 (%_% ymm5) (%_% ymm0) (%_% ymm1) (Imm8 (word 32)) *)
  0xc4; 0xe3; 0x7d; 0x46; 0xc1; 0x31;
                           (* VPERM2I128 (%_% ymm0) (%_% ymm0) (%_% ymm1) (Imm8 (word 49)) *)
...
let sha3_keccak4_f1600_alt_2_7_tmc = define_trimmed "sha3_keccak4_f1600_alt_2_7_tmc" sha3_keccak4_f1600_alt_2_7_mc;;

let sha3_keccak4_f1600_alt_2_7_EXEC = X86_MK_CORE_EXEC_RULE sha3_keccak4_f1600_alt_2_7_tmc;;
...
let sha3_keccak4_f1600_alt_2_7_CORRECT = prove
  (`!rc_pointer:int64 bitstate_in:int64 rho8_ptr:int64 rho56_ptr:int64 A1 A2 A3 A4 pc:num stackpointer:int64.
  nonoverlapping_modulo (2 EXP 64) (pc, 0x9f7) (val stackpointer, 0x300) /\
  nonoverlapping_modulo (2 EXP 64) (pc, 0x9f7) (val bitstate_in, 800) /\
  nonoverlapping_modulo (2 EXP 64) (pc, 0x9f7) (val rc_pointer, 192) /\
  nonoverlapping_modulo (2 EXP 64) (val bitstate_in,800) (val rc_pointer,192) /\
  nonoverlapping_modulo (2 EXP 64) (val bitstate_in,800) (val stackpointer, 0x300) /\
  nonoverlapping_modulo (2 EXP 64) (val stackpointer, 0x300) (val rc_pointer,192) /\
  
  nonoverlapping_modulo (2 EXP 64) (pc, 0x9f7) (val rho8_ptr, 32) /\
  nonoverlapping_modulo (2 EXP 64) (val rho8_ptr, 32) (val stackpointer, 0x300) /\
  nonoverlapping_modulo (2 EXP 64) (val rho8_ptr, 32) (val bitstate_in, 800) /\
  nonoverlapping_modulo (2 EXP 64) (val rho8_ptr, 32) (val rc_pointer, 192) /\

  nonoverlapping_modulo (2 EXP 64) (pc, 0x9f7) (val rho56_ptr, 32) /\
  nonoverlapping_modulo (2 EXP 64) (val rho56_ptr, 32) (val stackpointer, 0x300) /\
  nonoverlapping_modulo (2 EXP 64) (val rho56_ptr, 32) (val bitstate_in, 800) /\
  nonoverlapping_modulo (2 EXP 64) (val rho56_ptr, 32) (val rc_pointer, 192) /\
  nonoverlapping_modulo (2 EXP 64) (val rho8_ptr, 32) (val rho56_ptr, 32)

  ==> ensures x86
         (\s. bytes_loaded s (word pc) (BUTLAST sha3_keccak4_f1600_alt_2_7_tmc) /\
  ...
  ENSURES_WHILE_PAUP_TAC `0` `24` `pc + 0x27c` `pc + 0x77c`
  `\i s.
      (read R10 s = word i /\
       read RDI s = bitstate_in /\
       read RSP s = stackpointer /\
       ...
       wordlist_from_memory(rho56_ptr,4) s = rho56_constant /\
       wordlist_from_memory(rc_pointer,24) s = round_constants /\
       (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND (APPEND
                                                    (wordlist_from_memory(word_add stackpointer (word 0x1e0),1) s)
                                                  (wordlist_from_memory(word_add stackpointer (word 0x100),1) s))
                                                (wordlist_from_memory(word_add stackpointer (word 0x120),1) s))
                                              (wordlist_from_memory(word_add stackpointer (word 0x140),1) s))
                                            (wordlist_from_memory(word_add stackpointer (word 0x160),1) s))
                                          (wordlist_from_memory(word_add stackpointer (word 0x180),1) s))
                                        (wordlist_from_memory(word_add stackpointer (word 0x200),1) s))
                                      (CONS (read YMM10 s) []))
                                    (CONS (read YMM14 s) []))
                                  (wordlist_from_memory(word_add stackpointer (word 0x220),1) s))
                                (wordlist_from_memory(word_add stackpointer (word 0x2e0),1) s))
                              (CONS (read YMM8 s) []))
                            (CONS (read YMM15 s) []))
                          (wordlist_from_memory(word_add stackpointer (word 0x2c0),1) s))
                        (wordlist_from_memory(word_add stackpointer (word 0x1a0),1) s))
                      (CONS (read YMM9 s) []))
                    (wordlist_from_memory(word_add stackpointer (word 0x2a0),1) s))
                  (wordlist_from_memory(word_add stackpointer (word 0x280),1) s))
                (CONS (read YMM13 s) []))
              (wordlist_from_memory(word_add stackpointer (word 0x260),1) s))
            (wordlist_from_memory(word_add stackpointer (word 0x1c0),1) s))
          (CONS (read YMM3 s) []))
        (CONS (read YMM7 s) []))
      (wordlist_from_memory(word_add stackpointer (word 0x240),1) s))
    (CONS (read YMM2 s) [])) =
  ...
  REPEAT CONJ_TAC THENL 
    ...
    X86_STEPS_TAC sha3_keccak4_f1600_alt_2_7_EXEC (1--96) THEN
    ...
    X86_STEPS_TAC sha3_keccak4_f1600_alt_2_7_EXEC (1--223) THEN
    ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
    REPEAT CONJ_TAC THENL
   ...
   X_GEN_TAC `i:num` THEN STRIP_TAC THEN VAL_INT64_TAC `i:num` THEN
    ...
    MEMORY_256_FROM_64_TAC "rho56_ptr" 0 4 THEN
    ASM_REWRITE_TAC[WORD_ADD_0] THEN REPEAT STRIP_TAC THEN
    X86_STEPS_TAC sha3_keccak4_f1600_alt_2_7_EXEC (1--1) THEN
...
let sha3_keccak4_f1600_alt_2_7_FULL_EXEC = X86_MK_EXEC_RULE sha3_keccak4_f1600_alt_2_7_tmc;;

let sha3_keccak4_f1600_alt_2_7_NOIBT_SUBROUTINE_CORRECT = prove
 (`!rc_pointer:int64 bitstate_in:int64 rho8_ptr:int64 rho56_ptr:int64 A1 A2 A3 A4 pc:num stackpointer:int64 returnaddress.
  nonoverlapping_modulo (2 EXP 64) (pc, LENGTH sha3_keccak4_f1600_alt_2_7_tmc) (val (word_sub stackpointer (word 0x31f)), 0x31f) /\
  nonoverlapping_modulo (2 EXP 64) (pc, LENGTH sha3_keccak4_f1600_alt_2_7_tmc) (val bitstate_in, 800) /\
  nonoverlapping_modulo (2 EXP 64) (pc, LENGTH sha3_keccak4_f1600_alt_2_7_tmc) (val rc_pointer, 192) /\
  nonoverlapping_modulo (2 EXP 64) (val bitstate_in, 800) (val rc_pointer, 192) /\
  ...
  ==> ensures x86
         (\s. bytes_loaded s (word pc) sha3_keccak4_f1600_alt_2_7_tmc /\
              read RIP s = word pc /\
              read RSP s = stackpointer /\
  ...
  REPLICATE_TAC 9 GEN_TAC THEN CHANGED_TAC(CONV_TAC(ONCE_DEPTH_CONV NUM_ADD_CONV)) THEN
  WORD_FORALL_OFFSET_TAC 0x31f THEN
  REWRITE_TAC[MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI] THEN
  REWRITE_TAC[C_ARGUMENTS] THEN
  REWRITE_TAC[fst sha3_keccak4_f1600_alt_2_7_FULL_EXEC] THEN
  REWRITE_TAC[WORDLIST_FROM_MEMORY] THEN
  CONV_TAC(ONCE_DEPTH_CONV NUM_MULT_CONV) THEN
  REPEAT STRIP_TAC THEN

  ENSURES_INIT_TAC "s0" THEN
  X86_STEPS_TAC sha3_keccak4_f1600_alt_2_7_FULL_EXEC (1--3) THEN
  ABBREV_TAC
   `delta =
  ...
  ANTS_TAC THENL [REPEAT(FIRST_X_ASSUM(MP_TAC o check (is_imp o concl))) THEN REPEAT NONOVERLAPPING_TAC; ALL_TAC] THEN
  ...
  REWRITE_TAC[WORDLIST_FROM_MEMORY] THEN
  CONV_TAC(ONCE_DEPTH_CONV NUM_MULT_CONV) THEN
  X86_BIGSTEP_TAC sha3_keccak4_f1600_alt_2_7_FULL_EXEC "s4" THENL
   [MATCH_MP_TAC BYTES_LOADED_BUTLAST THEN ASM_REWRITE_TAC[];
    ALL_TAC] THEN
  X86_STEPS_TAC sha3_keccak4_f1600_alt_2_7_FULL_EXEC (5--6) THEN
...
let sha3_keccak4_f1600_alt_2_7_SUBROUTINE_CORRECT = prove
 (`!rc_pointer:int64 bitstate_in:int64 A1 A2 A3 A4 pc:num stackpointer:int64 returnaddress.
  ...
  MATCH_ACCEPT_TAC(ADD_IBT_RULE
    (CONV_RULE TWEAK_CONV sha3_keccak4_f1600_alt_2_7_NOIBT_SUBROUTINE_CORRECT)));;
...
let sha3_keccak4_f1600_alt_2_7_WINDOWS_SUBROUTINE_CORRECT = prove
 ...
 let TWEAK_CONV = ONCE_DEPTH_CONV NUM_ADD_CONV THENC
  ...
  CONV_TAC TWEAK_CONV THEN
  MATCH_ACCEPT_TAC(ADD_IBT_RULE
    (CONV_RULE TWEAK_CONV sha3_keccak4_f1600_alt_2_7_NOIBT_WINDOWS_SUBROUTINE_CORRECT)));;
