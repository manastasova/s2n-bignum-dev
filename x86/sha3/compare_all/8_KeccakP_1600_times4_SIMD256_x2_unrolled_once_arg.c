...
#define ROL64in256_8(d, a) ROL64in256(d, a, 8)
#define ROL64in256_56(d, a) ROL64in256(d, a, 56)
...
void mlk_keccakf1600x4_permute24_x2_unrolled_one_arg(void *states, const uint64_t rc[24])
{
