...
#define ROL64in256_1(d, a) \
  d = _mm256_or_si256(_mm256_add_epi64(a, a), _mm256_srli_epi64(a, 63))
...
void mlk_keccakf1600x4_permute24_x2_unrolled_one_arg_special_rho_adds(void *states, const uint64_t rc[24])
{
