/*
 * Standalone version of the original mlkem-native Keccak-f1600x4 implementation
 * for testing and benchmarking purposes.
 *
 * Compilation:
 *   gcc -mavx2 -c KeccakP_1600_times4_SIMD256_org_standalone.c -o keccak_org.o
 */
...
#define thetaRhoPiChiIotaPrepareTheta(i, A, E)                \
  ...
  E##be = XOR256(Bbe, ANDnu256(Bbi, Bbo)); Ce = E##be;        \
  XOReq256(A##su, Du); ROL64in256(Bbu, A##su, 14);            \
  E##bi = XOR256(Bbi, ANDnu256(Bbo, Bbu)); Ci = E##bi;        \
  E##bo = XOR256(Bbo, ANDnu256(Bbu, Bba)); Co = E##bo;        \
  E##bu = XOR256(Bbu, ANDnu256(Bba, Bbe)); Cu = E##bu;        \
  XOReq256(A##bo, Do); ROL64in256(Bga, A##bo, 28);            \
  XOReq256(A##gu, Du); ROL64in256(Bge, A##gu, 20);            \
  XOReq256(A##ka, Da); ROL64in256(Bgi, A##ka, 3);             \
  E##ga = XOR256(Bga, ANDnu256(Bge, Bgi)); XOReq256(Ca, E##ga); \
  XOReq256(A##me, De); ROL64in256(Bgo, A##me, 45);            \
  E##ge = XOR256(Bge, ANDnu256(Bgi, Bgo)); XOReq256(Ce, E##ge); \
  XOReq256(A##si, Di); ROL64in256(Bgu, A##si, 61);            \
  E##gi = XOR256(Bgi, ANDnu256(Bgo, Bgu)); XOReq256(Ci, E##gi); \
  E##go = XOR256(Bgo, ANDnu256(Bgu, Bga)); XOReq256(Co, E##go); \
  E##gu = XOR256(Bgu, ANDnu256(Bga, Bge)); XOReq256(Cu, E##gu); \
  XOReq256(A##be, De); ROL64in256(Bka, A##be, 1);             \
  XOReq256(A##gi, Di); ROL64in256(Bke, A##gi, 6);             \
  XOReq256(A##ko, Do); ROL64in256(Bki, A##ko, 25);            \
  E##ka = XOR256(Bka, ANDnu256(Bke, Bki)); XOReq256(Ca, E##ka); \
  XOReq256(A##mu, Du); ROL64in256_8(Bko, A##mu);              \
  E##ke = XOR256(Bke, ANDnu256(Bki, Bko)); XOReq256(Ce, E##ke); \
  XOReq256(A##sa, Da); ROL64in256(Bku, A##sa, 18);            \
  E##ki = XOR256(Bki, ANDnu256(Bko, Bku)); XOReq256(Ci, E##ki); \
  E##ko = XOR256(Bko, ANDnu256(Bku, Bka)); XOReq256(Co, E##ko); \
  E##ku = XOR256(Bku, ANDnu256(Bka, Bke)); XOReq256(Cu, E##ku); \
  XOReq256(A##bu, Du); ROL64in256(Bma, A##bu, 27);            \
  XOReq256(A##ga, Da); ROL64in256(Bme, A##ga, 36);            \
  XOReq256(A##ke, De); ROL64in256(Bmi, A##ke, 10);            \
  E##ma = XOR256(Bma, ANDnu256(Bme, Bmi)); XOReq256(Ca, E##ma); \
  XOReq256(A##mi, Di); ROL64in256(Bmo, A##mi, 15);            \
  E##me = XOR256(Bme, ANDnu256(Bmi, Bmo)); XOReq256(Ce, E##me); \
  XOReq256(A##so, Do); ROL64in256_56(Bmu, A##so);             \
  E##mi = XOR256(Bmi, ANDnu256(Bmo, Bmu)); XOReq256(Ci, E##mi); \
  E##mo = XOR256(Bmo, ANDnu256(Bmu, Bma)); XOReq256(Co, E##mo); \
  E##mu = XOR256(Bmu, ANDnu256(Bma, Bme)); XOReq256(Cu, E##mu); \
  XOReq256(A##bi, Di); ROL64in256(Bsa, A##bi, 62);            \
  XOReq256(A##go, Do); ROL64in256(Bse, A##go, 55);            \
  XOReq256(A##ku, Du); ROL64in256(Bsi, A##ku, 39);            \
  E##sa = XOR256(Bsa, ANDnu256(Bse, Bsi)); XOReq256(Ca, E##sa); \
  XOReq256(A##ma, Da); ROL64in256(Bso, A##ma, 41);            \
  E##se = XOR256(Bse, ANDnu256(Bsi, Bso)); XOReq256(Ce, E##se); \
  XOReq256(A##se, De); ROL64in256(Bsu, A##se, 2);             \
  E##si = XOR256(Bsi, ANDnu256(Bso, Bsu)); XOReq256(Ci, E##si); \
  E##so = XOR256(Bso, ANDnu256(Bsu, Bsa)); XOReq256(Co, E##so); \
  E##su = XOR256(Bsu, ANDnu256(Bsa, Bse)); XOReq256(Cu, E##su);
...
void mlk_keccakf1600x4_permute24_org(void *states)
{
