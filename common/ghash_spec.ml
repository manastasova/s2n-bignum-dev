...
(* ========================================================================= *)
(* 3-block Horner unrolling: ghash_polyval_acc h a [p;q;r] = prop3(...)      *)
(* Processing 3 GHASH blocks iteratively equals a batched computation:       *)
(*   (a⊕p)·h³ + q·h² + r·h  followed by Prop 3 reduction                     *)
(* This matches the 3-block tail of AES-GCM.                                 *)
(* ========================================================================= *)
