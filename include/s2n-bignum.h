...
// Input H[2]; output Htable. In AWS-LC terms the output is "u128 Htable[16]"
// (256 bytes), of which only the first 12 128-bit entries (192 bytes) are
// written; here that buffer is viewed as uint64_t Htable[32], words [0..23].
