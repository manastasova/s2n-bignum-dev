...
extern void gcm_init_v8 (uint64_t Htable[6], const uint64_t H[2]);

// GHASH polynomial multiply: Xi = H * Xi (mod x^128 + x^7 + x^2 + x + 1)
// Inputs Xi[2], Htable[6]; output Xi[2]
extern void gcm_gmult_v8 (uint64_t Xi[2], const uint64_t Htable[6]);
