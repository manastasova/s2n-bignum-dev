...
#ifdef __x86_64__
extern void sha3_keccak4_f1600_alt(uint64_t a[S2N_BIGNUM_STATIC 100],const uint64_t rc[S2N_BIGNUM_STATIC 24], const uint64_t mlk_rho8[4], const uint64_t mlk_rho56[4]);
extern void sha3_keccak4_f1600_alt2(uint64_t a[S2N_BIGNUM_STATIC 100],const uint64_t rc[S2N_BIGNUM_STATIC 24], const uint64_t mlk_rho8[4], const uint64_t mlk_rho56[4]);
#else
