...
// MD5 compression function (RFC 1321), processing "num" 64-byte blocks
// Inputs state[4], data[64*num]; output state[4]
extern void md5_block(uint32_t state[S2N_BIGNUM_STATIC 4], const uint8_t *data, size_t num);
