...
// Whole-blocks-only variant of aesv8_gcm_8x_dec_256: fused AES-256 counter-mode
// decrypt + GHASH-over-ciphertext. Requires "bit_len" to be a nonzero multiple
// of 128 (whole 16-byte blocks) and returns 0 having touched no memory
// otherwise. No partial-final-block masking.
// Inputs in[bit_len], bit_len, xi[16], ivec[16], key[244], htable[32]; outputs function return, out[bit_len], xi[16], ivec[16]
